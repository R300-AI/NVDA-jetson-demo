...
# Lab 5, 6 (需要 Eigen)
nvcc labX_xxx.cu -o labX -O2 -arch=sm_87 -I/usr/include/eigen3
```
...
| P5 | `lab5_reshape.cu` | `nvcc lab5_reshape.cu -o lab5 -O2 -arch=sm_87 -I/usr/include/eigen3` | Memory Operations (Zero-Copy) |
| P6 | `lab6_norm.cu` | `nvcc lab6_norm.cu -o lab6 -O2 -arch=sm_87 -I/usr/include/eigen3` | Memory Throughput、Kernel Launch Overhead |
